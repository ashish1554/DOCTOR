...
//       {/* Profile Image */}
//       <img className="w-36 rounded mx-auto md:mx-0" src={userData.image} alt="" />
...
//         />
//       ) : (
//         <p className="text-gray-700 text-3xl font-semibold text-center md:text-left">
//           {userData.name}
//         </p>
//       )}
//       <hr />
...
//         <div className="text-slate-600 flex flex-col gap-3">
//           {/* Email */}
//           <div className="flex flex-row gap-7 md:gap-7">
//             <p className="font-semibold">Email id:</p>
//             <p className="text-blue-500 break-all">{userData.email}</p>
//           </div>

//           {/* Phone */}
//           <div className="flex flex-row gap-8 md:gap-8">
//             <p className="font-semibold">Phone:</p>
//             {isEdit ? (
//               <input
...
//         {isEdit ? (
//           <button
//             className="border-2 border-blue-400 rounded-full w-[207px] p-3 text-center mt-5 hover:bg-primary hover:text-white cursor-pointer"
...
//         ) : (
//           <button
//             className="border-2 border-blue-400 rounded-full w-[127px] p-3 text-center mt-5 hover:bg-primary hover:text-white cursor-pointer"
