...
//     </div>
//     <div className='flex '>
//       <img className='w-[500px] p-14  ml-5' src={assets.about_image} alt="" />
//       <div className=' flex flex-col gap-5 text-gray-500 mt-28'>
//         <p className='font-bold text-gray-700'>OUR OFFICE</p>
//         <p className='text-sm'>54709 Willms Station <br />Suite 350, Washington, USA</p>
...
//         <button className='text-xs rounded-md border-2 border-gray-600 p-3 w-1/2 hover:bg-primary hover:text-white'>Explore Jobs</button>
//       </div>
//     </div>
//    </div>
//   )
