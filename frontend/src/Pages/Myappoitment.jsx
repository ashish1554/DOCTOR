...
//       <div>
//         {appointments.map((item, index) => (
//           <div className='flex flex-col md:flex-row gap-6 border-b pb-6 mt-6' key={index}>

//             {/* Image Section */}
//             <div className='w-full md:w-[220px] h-[200px] overflow-hidden rounded-md'>
//               <img className='w-full h-full object-cover rounded-md' src={item.docData.image} alt="Doctor" />
//             </div>
...
//             {/* Button Section */}
//             <div className='flex flex-col gap-3 ml-auto pt-4 md:pt-12 w-full md:w-[220px]'>

//               {!item.cancelled && item.payment && !item.isCompleted && (
//                 <button className='w-full py-2 rounded text-stone-500 bg-indigo-50'>Paid</button>
//               )}
...
//                   <button
//                     onClick={() => appointmentRazorPay(item._id)}
//                     className='w-full border-2 border-gray-500 px-5 py-2 hover:bg-primary hover:text-white cursor-pointer rounded-md whitespace-nowrap'>
//                     Pay Online
//                   </button>
//                   <button
//                     onClick={() => cancelAppointment(item._id)}
//                     className='w-full border-2 border-gray-500 px-5 py-2 hover:bg-red-600 hover:text-white cursor-pointer rounded-md whitespace-nowrap'>
//                     Cancel Appointment
//                   </button>
//                 </>
//               )}
...
//               {item.isCompleted && (
//                 <button className='w-full py-2 border border-green-500 rounded text-green-500'>
//                   Completed
//                 </button>
//               )}
//             </div>
