...
//         <div className='w-[60%] bg-primary rounded-lg '>
//           <img className='h-full w-full' src={docInfo.image} alt="" />
//         </div>
//         <div className='flex flex-col gap-4  py-10 px-8 border-2 border-gray-300 rounded-xl'>
//           <div className='flex flex-col gap-2'>
//             <div className='flex flex-row gap-2 items-center'>
//               <p className='text-3xl'>{docInfo.name}</p>
