...
//         </div>
//         <div className={`flex-col gap-5 w-[200px] ${showFilter ? 'flex':'hidden sm:flex'}`}>
//          <p onClick={()=>speciality==='General physician' ? navigate('/doctors'):navigate('/doctors/General physician')} className='text-gray-600 border-2 border-gray-400 rounded-lg px-2 py-2 hover:bg-blue-100 cursor-pointer text-sm'>General physician</p>
//           <p onClick={()=>speciality==='Gynecologist' ? navigate('/doctors'):navigate('/doctors/Gynecologist')} className='text-gray-600 border-2 border-gray-400 rounded-lg px-2 py-2 hover:bg-blue-100 cursor-pointer text-sm'>Gynecologist</p>
//           <p onClick={()=>speciality==='Dermatologist' ? navigate('/doctors'):navigate('/doctors/Dermatologist')} className='text-gray-600 border-2 border-gray-400 rounded-lg px-2 py-2 hover:bg-blue-100 cursor-pointer text-sm'>Dermatologist</p>
//           <p onClick={()=>speciality==='Pediatricians' ? navigate('/doctors'):navigate('/doctors/Pediatricians')} className='text-gray-600 border-2 border-gray-400 rounded-lg px-2 py-2 hover:bg-blue-100 cursor-pointer text-sm'>Pediatricians</p>
//           <p onClick={()=>speciality==='Neurologist' ? navigate('/doctors'):navigate('/doctors/Neurologist')} className='text-gray-600 border-2 border-gray-400 rounded-lg px-2 py-2 hover:bg-blue-100 cursor-pointer text-sm'>Neurologist</p>
//           <p onClick={()=>speciality==='Gastroenterologist' ? navigate('/doctors'):navigate('/doctors/Gastroenterologist')} className='text-gray-600 border-2 border-gray-400 rounded-lg px-2 py-2 hover:bg-blue-100 cursor-pointer text-sm'>Gastroenterologist</p>
//         </div>
//       </div>
//       {/* right */}
//       <div className='w-full grid grid-cols-auto gap-4 pt-14 gap-y-6 px-3 sm:px-0'>
