...
//     const logout=()=>{
//        navigte('/')  // Redirect to Home page after logout
//        aToken && setAToken('')
...
//             <p className='text-sm text-gray-600 border rounded-full border-gray-800 px-5 py-1'>{aToken?'Admin':'Doctor'}</p>
//         </div>
//         <button onClick={logout} className='bg-primary text-white px-12 py-2 rounded-full'>Logout</button>
//     </div>
//   )
// }
